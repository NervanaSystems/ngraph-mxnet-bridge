...
ifneq ($(CPU_TARGET_ARCH),)
	NGRAPH_ARCH_CMAKE_FLAGS := -DNGRAPH_TARGET_ARCH=$(CPU_TARGET_ARCH) -DNGRAPH_TUNE_ARCH=$(CPU_TARGET_ARCH)
else
...
$(NGRAPH_BRIDGE_OBJ): %.o: ngraph $(NGRAPH_BRIDGE_SRC)
  ...
  ifeq ($(USE_NGRAPH_INTERPRETER),1)
    NGRAPH_CFLAGS += -DMXNET_USE_NGRAPH_INTERPRETER=1
  endif
